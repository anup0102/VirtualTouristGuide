...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void YOLO(View Button){
        ...
        if (startYolo == false){
            ...
            if (firstTimeYolo == false){
                firstTimeYolo = true;
                String tinyYoloCfg = Environment.getExternalStorageDirectory() + "/dnns/yolov3_custom.cfg" ;
                String tinyYoloWeights = Environment.getExternalStorageDirectory() + "/dnns/yolov3_custom_last.weights";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btndetect = findViewById(R.id.button3);
        ...
        if(startYolo == true){
            ...
            if (ArrayLength>=1) {
                ...
                for (int i = 0; i < ind.length; ++i) {
                    ...
                    final List<String> cocoNames = Arrays.asList("Agra Fort", "Taj Mahal", "Lotus Temple", "Shaniwar Wada", "Hawa Mahal");
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            String name = cocoNames.get(idGuy);
